                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="text-center">
                            <img id="circle" class="refresh" src="{{ asset('img/img_circle.png') }}" height="250px"
                                width="250px" alt="">
                        ...
                        <div class="text-center">
                            <label for="bet" class="font-weight-bold h5">Bet</label>
                            ...
                            <p id="timer" class="h5 text-danger">Stop</p>
